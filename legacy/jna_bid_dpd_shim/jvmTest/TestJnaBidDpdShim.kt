...
class TestJnaBidDpdShim {
    ...
    fun test1() {
        ...
        for (v in values) {
            ...
            println("d128 DPD hex: ${d128_dpd.spacedHex()}  rt=\"$d128_dpd_rt\"")
            println("d128 BID hex: ${d128_bid.spacedHex()}  rt=\"$d128_bid_rt\"")
            ...
            println(" d64 DPD hex: ${d64_dpd.spacedHex()}  rt=\"$d64_dpd_rt\"")
            println(" d64 BID hex: ${d64_bid.spacedHex()}  rt=\"$d64_bid_rt\"")
        }
    }
