...
internal fun encodeBigEndianDpd128(bigEndianLongs: LongArray, d: MutDec): LongArray {
...
internal fun encodeBigEndianDpd128(bigEndianBytes: ByteArray, d: MutDec): ByteArray {
    require(d.digitLen <= 34)
...
internal fun encodeLittleEndianDpd128(littleEndianLongs: LongArray, d: MutDec): LongArray {
    require(d.digitLen <= 34)
...
internal fun encodeLittleEndianDpd128(littleEndianBytes: ByteArray, d: MutDec): ByteArray {
    require(d.digitLen <= 34)
...
internal fun decodeBigEndianDpd128(d: MutDec, bigEndianLongs: LongArray): MutDec {
    require(d.digitLen <= 34)
    require(bigEndianLongs.size == 2)
...
internal fun decodeBigEndianDpd128(d: MutDec, bigEndianBytes: ByteArray): MutDec {
    require(d.digitLen <= 34)
    require(bigEndianBytes.size == 16)
    var dpdHi = 0L
    var dpdLo = 0L
...
internal fun decodeLittleEndianDpd128(d: MutDec, littleEndianLongs: LongArray): MutDec {
    require(d.digitLen <= 34)
    require(littleEndianLongs.size == 2)
...
internal fun decodeLittleEndianDpd128(d: MutDec, littleEndianBytes: ByteArray): MutDec {
    require(d.digitLen <= 34)
    require(littleEndianBytes.size == 16)
    var dpdHi = 0L
    var dpdLo = 0L
