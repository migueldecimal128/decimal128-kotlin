...
object D128AddSub {
    ...
    fun addImpl(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
    ...
    private fun unscaledFiniteAddImpl(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
    ...
    private fun unscaledFiniteAddZero(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
    ...
    private fun scaledFiniteAddZero(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
        check(x.isZero() || y.isZero())
    ...
    private fun unscaledFiniteAddMagnitudes(x: Decimal, y: Decimal, env: env): Decimal {
    ...
    private fun scaledFiniteAdd(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
    ...
    private fun scaledFiniteSubMagnitudes(resultSign: Boolean, m: Decimal, n: Decimal, env: env): Decimal {
    ...
    private fun scaledFiniteAddMagnitudes(x: Decimal, y: Decimal, env: env): Decimal {
    ...
    private fun infiniteAddImpl(x: Decimal, ySign: Boolean, y: Decimal, env: env): Decimal {
        val qX = x.qExp
        val qY = y.qExp
