...
object U256Set {
    ...
    fun u256Set(u: C256, x: LongArray, xOff: Int, xLen: Int) {
        u.c256SetZero()
        if (xLen == 0)
            return
    ...
    fun u256SetShiftRight(z: C256, x: C256, bitShift: Int) {
        if (x.bitLen <= 64) {
    ...
    inline fun u256SetShiftLeft(z: C256, x: C256, s: Int) = u256SetShiftLeftOr(z, x, s, 0L)

    fun u256SetShiftLeftOr(z: C256, x: C256, s: Int, d0: Long) {
    ...
    fun u256SetShiftRight(z: C256, x: LongArray, xOff: Int, xLen: Int, bitCount: Int) {
