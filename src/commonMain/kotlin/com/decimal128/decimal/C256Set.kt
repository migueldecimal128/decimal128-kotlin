...
object C256Set {
    ...
    fun c256Set(z: C256, car: IntArray)  = c256Set(z, car, Magia.nonZeroLimbLen(car))

    fun c256Set(z: C256, car: IntArray, carLen: Int) {
    ...
    fun c256Set(z: C256, x: LongArray, xOff: Int, xLen: Int) {
        z.c256SetZero()
        if (xLen == 0)
            return
    ...
    fun c256SetShiftRight(z: C256, x: C256, bitShift: Int) {
        if (x.bitLen <= 64) {
    ...
    inline fun c256SetShiftLeft(z: C256, x: C256, s: Int) = c256SetShiftLeftOr(z, x, s, 0L)

    fun c256SetShiftLeftOr(z: C256, x: C256, s: Int, d0: Long) {
    ...
    fun c256SetShiftRight(z: C256, x: LongArray, xOff: Int, xLen: Int, bitCount: Int) {
