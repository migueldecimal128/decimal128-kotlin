...
private fun parseStringToBi(str: String): BigInteger {
    val s = str.replace(com.decimal128.decimal.regexPlusUnderscore, "")
    val bi = when {
...
class TestInt256Arithmetic {
    ...
    data class TC(val strA: String, val strB: String) {
        ...
        val biA = com.decimal128.decimal.parseStringToBi(strA)
        val biB = com.decimal128.decimal.parseStringToBi(strB)
        val sum = biA + biB
        val diff = biA - biB
        val prod = biA * biB
        val square = biA * biA
    ...
    fun testProblemChild() {
        ...
        val a = com.decimal128.decimal.Int256(strA)
        val b = com.decimal128.decimal.Int256(strB)
        val rem = a % b
