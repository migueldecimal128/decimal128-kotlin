...
class TestResidualRounding {
    ...
    val roundingCases = arrayOf(
        ...
        RoundingDirectionCase(ROUND_TIES_TO_EVEN, EXACT, 3, true, 0),

        RoundingDirectionCase(ROUND_TIES_TO_EVEN, HALF, 0, false, 0),
        RoundingDirectionCase(ROUND_TIES_TO_EVEN, HALF, 0, true, 0),
        RoundingDirectionCase(ROUND_TIES_TO_EVEN, HALF, 5, false, 1),
        RoundingDirectionCase(ROUND_TIES_TO_EVEN, HALF, 7, true, 1),
        ...
        RoundingDirectionCase(ROUND_TIES_TO_EVEN, BIAS_TRUNC, 9, false, 1),
        ...
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, EXACT, 3, false, 0),
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, EXACT, 5, true, 0),

        RoundingDirectionCase(ROUND_TIES_TO_AWAY, HALF, 0, false, 1),
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, HALF, 0, true, 1),
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, HALF, 7, false, 1),
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, HALF, 9, true, 1),
        ...
        RoundingDirectionCase(ROUND_TIES_TO_AWAY, BIAS_TRUNC, 3, true, 1),

        // roundTowardZero
        RoundingDirectionCase(ROUND_TOWARD_ZERO, EXACT, 0, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, EXACT, 0, true, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, EXACT, 5, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, EXACT, 7, true, 0),

        RoundingDirectionCase(ROUND_TOWARD_ZERO, HALF, 0, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, HALF, 0, true, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, HALF, 9, false, 0),
        ...
        RoundingDirectionCase(ROUND_TOWARD_ZERO, BIAS_TRUNC, 3, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_ZERO, BIAS_TRUNC, 5, true, 0),

        // roundTowardPositive
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, EXACT, 0, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, EXACT, 0, true, 0),
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, EXACT, 7, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, EXACT, 9, true, 0),
        ...
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, HALF, 3, true, 0),
        ...
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, BIAS_TRUNC, 5, false, 2),
        RoundingDirectionCase(ROUND_TOWARD_POSITIVE, BIAS_TRUNC, 7, true, 0),

        // roundTowardNegative
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, EXACT, 0, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, EXACT, 0, true, 0),
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, EXACT, 9, false, 0),
        ...
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, HALF, 3, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, HALF, 5, true, 2),
        ...
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, BIAS_TRUNC, 7, false, 0),
        RoundingDirectionCase(ROUND_TOWARD_NEGATIVE, BIAS_TRUNC, 9, true, 2),
    ...
    fun test1(tc: RoundingDirectionCase) {
        ...
        val observedBias = tc.residual.halfUlpBias(effectiveRoundingDirection, tc.lsdw)
