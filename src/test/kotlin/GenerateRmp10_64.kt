...
class GenerateRmp10_64 {
    companion object {
        ...
        fun calcMinY10(qDigitCount:Int, xPow10:Int) : Int {
            ...
            if (! verifyY10(qDigitCount, xPow10, theoreticalMinY10))
                throw RuntimeException("?que?")
            var minY10 = theoreticalMinY10
            while (verifyY10(qDigitCount, xPow10, minY10 - 1))
                --minY10
            return minY10
        }

        fun verifyY10(qDigitCount: Int, xPow10: Int, yFractionalBitCount: Int): Boolean {
