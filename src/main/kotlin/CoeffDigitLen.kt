...
object CoeffDigitLen {
    ...
    fun calcDigitLen192(dw2: Long, dw1: Long, dw0: Long): Int {
        if (dw2 == 0L)
            return calcDigitLen128(dw1, dw0)
    ...
    fun calcDigitLen256(dw3: Long, dw2: Long, dw1: Long, dw0: Long): Int {
        if (dw3 == 0L)
            return calcDigitLen192(dw2, dw1, dw0)
