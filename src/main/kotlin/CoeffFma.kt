...
class CoeffFma {
    companion object {
        fun fmaCoeff(p:Coeff, x:Coeff, yDigitCount:Int, y0:Long, a:Coeff) {
            _fma(p, x.digitCount, x.dw3, x.dw2, x.dw1, x.dw0,
        ...
        fun fmaCoeff(p:Coeff, x:Coeff, yDigitCount:Int, y2:Long, y1:Long, y0:Long, aDigitCount:Int, a1:Long, a0:Long) {
            if ((x.dw3 or x.dw2) == 0L) {
                if (x.dw1 == 0L)
        ...
        fun fmaCoeff(p:Coeff, x:Coeff, yDigitCount:Int, y3:Long, y2:Long, y1:Long, y0:Long, aDigitCount:Int, a1:Long, a0:Long) {
            if ((x.dw3 or x.dw2) == 0L) {
                if (x.dw1 == 0L)
                    _fma(p, x.digitCount, x.dw0, yDigitCount, y3, y2, y1, y0, aDigitCount, a1, a0)
                else
                    _fma(p, x.digitCount, x.dw3, x.dw2, x.dw1, x.dw0, yDigitCount, y3, y2, y1, y0, aDigitCount, 0L, 0L, a1, a0)
            } else {
                _fma(p, x.digitCount, x.dw3, x.dw2, x.dw1, x.dw0,
