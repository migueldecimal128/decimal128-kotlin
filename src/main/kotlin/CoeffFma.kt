    ...
    companion object {
        ...
        private fun _fma(p: Coeff,
            ...
            if (hiSumDigitCount < POW10_192_OFFSET) {
                ...
                p.dw1 = p1
                p.dw2 = 0L; p.dw3 = 0L;
                p.digitCount = if (p1 == 0L) calcDigitCount64(p0) else calcDigitCount128(p1, p0)
                return
            }
            ...
            if (hiSumDigitCount < POW10_256_OFFSET) {
                ...
                p.dw2 = p2
                p.dw3 = 0L;
                p.digitCount = if (p2 == 0L) calcDigitCount128(p1, p0) else calcDigitCount192(p2, p1, p0)
                return
            }
            ...
            if (hiSumDigitCount < POW10_MAX_OFFSET) {
                ...
                p.dw2 = p2
                p.dw3 = p3
                p.digitCount = if (p3 == 0L) calcDigitCount192(p2, p1, p0) else calcDigitCount256(p3, p2, p1, p0)
                return
            }
