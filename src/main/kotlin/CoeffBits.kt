    ...
    fun coeffShiftRight(c: Coeff, bitShift: Int) {
        ...
        if (innerShift == 0) {
            when (wholeDwordCount) {
                0 -> return
                1 -> {
                    c.dw0 = c.dw1; c.dw1 = c.dw2; c.dw2 = c.dw3; c.dw3 = 0L; setDigitCount192(c)
                }

                2 -> {
                    c.dw0 = c.dw2; c.dw1 = c.dw3; c.dw2 = 0L; c.dw3 = 0L; setDigitCount128(c)
                }

                3 -> {
                    c.dw0 = c.dw3; c.dw1 = 0L; c.dw2 = 0L; c.dw3 = 0L; setDigitCount64(c)
                }
            ...
            when (wholeDwordCount) {
                0 -> {
                    c.dw0 = (c.dw1 shl leftShift) or (c.dw0 ushr innerShift)
                    c.dw1 = (c.dw2 shl leftShift) or (c.dw1 ushr innerShift)
                    c.dw2 = (c.dw3 shl leftShift) or (c.dw2 ushr innerShift)
                    c.dw3 = c.dw3 ushr innerShift
                    setDigitCount256(c)
                }

                1 -> {
                    c.dw0 = (c.dw2 shl leftShift) or (c.dw1 ushr innerShift)
                    c.dw1 = (c.dw3 shl leftShift) or (c.dw2 ushr innerShift)
                ...
                2 -> {
                    c.dw0 = (c.dw3 shl leftShift) or (c.dw2 ushr innerShift)
    ...
    fun coeffSetShiftRight(c: Coeff, x: LongArray, xOff: Int, xLen: Int, bitCount: Int) {
        ...
        if (innerShift == 0) {
            when (newLen) {
                0 -> {}
                1 -> {
                    c.dw0 = x[shiftOff + 0]; setDigitCount64(c)
                }

                2 -> {
                    c.dw0 = x[shiftOff + 0]; c.dw1 = x[shiftOff + 1]; setDigitCount128(c)
                }

                3 -> {
                    c.dw0 = x[shiftOff + 0]; c.dw1 = x[shiftOff + 1]; c.dw2 = x[shiftOff + 2]; setDigitCount192(c)
                }

                4 -> {
                    c.dw0 = x[shiftOff + 0]; c.dw1 = x[shiftOff + 1]; c.dw2 = x[shiftOff + 2]
                    c.dw3 = x[shiftOff + 3]; setDigitCount256(c)
                }
        ...
        when (newLen) {
            0 -> {}
            1 -> {
                c.dw0 = x[shiftOff + 0] ushr innerShift; setDigitCount64(c)
            }

            2 -> {
                c.dw0 = (x[shiftOff + 1] shl leftShift) or (x[shiftOff + 0] ushr innerShift)
            ...
            3 -> {
                c.dw0 = (x[shiftOff + 1] shl leftShift) or (x[shiftOff + 0] ushr innerShift)
                c.dw1 = (x[shiftOff + 2] shl leftShift) or (x[shiftOff + 1] ushr innerShift)
            ...
            4 -> {
                c.dw0 = (x[shiftOff + 1] shl leftShift) or (x[shiftOff + 0] ushr innerShift)
                c.dw1 = (x[shiftOff + 2] shl leftShift) or (x[shiftOff + 1] ushr innerShift)
                c.dw2 = (x[shiftOff + 3] shl leftShift) or (x[shiftOff + 2] ushr innerShift)
            ...
            5 -> {
                ...
                c.dw1 = (x[shiftOff + 2] shl leftShift) or (x[shiftOff + 1] ushr innerShift)
                c.dw2 = (x[shiftOff + 3] shl leftShift) or (x[shiftOff + 2] ushr innerShift)
                c.dw3 = (x[shiftOff + 4] shl leftShift) or (x[shiftOff + 3] ushr innerShift)
