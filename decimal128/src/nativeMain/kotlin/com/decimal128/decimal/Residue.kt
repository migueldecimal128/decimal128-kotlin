...
actual value class Residue internal constructor(val value:Int) {
    ...
    actual companion object {
        ...
        actual fun fromValueDecade(c:C256): Residue {
        ...
        actual fun fromValueDecade(x: Decimal): Residue {
        ...
        actual fun fromValuePow10(dw1: Long, dw0: Long, pow10: Int): Residue {
        ...
        actual fun fromRoundBitStickyBitsStickyBits(isolatedRoundBit: Long, stickyBitsFracCompare: Int, stickyBitsPow2: Long) : Residue {
        ...
        actual fun fromRoundBitStickBit(roundBit: Int, stickyBit: Int) : Residue {
        ...
        actual fun fromRoundBitStickyBits(isolatedRoundBit: Long, stickyBits: Long) : Residue {
        ...
        actual fun fromRemainderDivisor(r: C256, d: C256): Residue {
            if (r.dw3 < 0L) {
        ...
        actual fun fromRemainderDivisor(remainder: Long, divisor: Long): Residue {
            val residue = when {
                remainder == 0L -> EXACT
        ...
        actual fun residueFromRemainderPow10(remainder: Long, pow10: Int): Residue {
    ...
    actual fun ulpRoundUp(decRounding: DecRounding, lsdwIsOdd: Long) : Boolean =
        ulpBias(decRounding, lsdwIsOdd) != 0L

    actual fun ulpRoundUp01L(decRounding: DecRounding, lsdwIsOdd: Long) : Long =
        -ulpBias(decRounding, lsdwIsOdd) ushr 63

    actual fun ulpBias(decRounding: DecRounding, lsdwIsOdd: Long) = ulpBiasY(decRounding, lsdwIsOdd)

    actual fun ulpBiasY(decRounding: DecRounding, lsdwIsOdd: Long) : Long {
    ...
    actual fun ulpBiasX(decRounding: DecRounding, lsdwIsOdd: Long) : Long {
