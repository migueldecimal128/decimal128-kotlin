...
class TestMutDecMagSub {
    ...
    val cases = arrayOf(
        TC("2E36", "1E0", TOWARD_ZERO),

        TC("1.000000000000000000000000000E26", "2.0000000009999999999E0", TOWARD_POSITIVE),
        TC("1.000000000000000000000000000E-2973", "2.0000000009999999999E-2999", TOWARD_POSITIVE),
        TC("1.125118998110872714580497160E-2973", "3.0306332009363000323E-2999", TOWARD_POSITIVE),
        TC("735087187510156E+2145", "539161499716564458254E+2105"),
        TC("7.35087187510156E+2159", "5.39161499716564458254E+2125"),
        TC("22E0", "1E1"),
        TC("4.574611751494966291851610463E-6043", "2.987013640E-6048", TOWARD_ZERO),
        TC("1.579E-3843", "2.12384601155035325007772872958E-3874"),

        TC("1E35", "10E0"),
        TC("3.4396855678324845813315E-5448", "3.0264730275769748987327314530281E-5479", TOWARD_ZERO),
        TC("1E35", "10E0"),
        TC("1E35", "100E0"),
        TC("1E35", "1000E0"),
        ...
        TC("1E35", "1E0"),
        TC("1E36", "1E0"),
        TC("2E33", "1E0", TIES_TO_AWAY),
        TC("2E34", "1E0", TIES_TO_AWAY),
        TC("2E35", "1E0", TIES_TO_AWAY),
        TC("2E36", "1E0", TIES_TO_AWAY),
        TC("1E33", "1E0", TIES_TO_AWAY),
        TC("1E34", "1E0", TIES_TO_AWAY),
        TC("1E35", "1E0", TIES_TO_AWAY),
        TC("1E36", "1E0", TIES_TO_AWAY),
        TC("2E33", "1E0", TOWARD_ZERO),
        TC("2E34", "1E0", TOWARD_ZERO),
        TC("2E35", "1E0", TOWARD_ZERO),
        TC("2E36", "1E0", TOWARD_ZERO),
        TC("1E33", "1E0", TOWARD_ZERO),
        TC("1E34", "1E0", TOWARD_ZERO),
        TC("1E35", "1E0", TOWARD_ZERO),
        TC("1E36", "1E0", TOWARD_ZERO),
        TC("2E33", "1E0", TOWARD_POSITIVE),
        TC("2E34", "1E0", TOWARD_POSITIVE),
        TC("2E35", "1E0", TOWARD_POSITIVE),
        TC("2E36", "1E0", TOWARD_POSITIVE),
        TC("1E33", "1E0", TOWARD_POSITIVE),
        TC("1E34", "1E0", TOWARD_POSITIVE),
        TC("1E35", "1E0", TOWARD_POSITIVE),
        TC("1E36", "1E0", TOWARD_POSITIVE),
        TC("3.4396855678324845813315E-5448", "3.0264730275769748987327314530281E-5479", TOWARD_ZERO),
        TC("1.0E100", "1E0", TOWARD_ZERO),
        TC("0E0", "0E1"),
        TC("0E+2565", "0E-2319"),
        TC("1E34", "1E0"),
        TC("1E35", "10E0"),
        ...
        TC("3.577396280843936609447212543753E4", "1e0", TOWARD_POSITIVE),
        TC("1", "1e-50", TOWARD_POSITIVE),
